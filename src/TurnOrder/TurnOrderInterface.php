...
interface TurnOrderInterface
{
     ...
     *
     * @param array<string, Actor> $actors All actors in the encounter (keyed by ID)
     * @param array<string, ActorState> $actorStates State for each actor (keyed by ID)
     ...
     * @param array<string, Actor> $allActors All actors in encounter (keyed by ID)
     * @param EncounterState $encounterState Current encounter state
     */
     ...
     * @param array<string, Actor> $actors All actors in the encounter
     * @param array<string, ActorState> $actorStates State for each actor (keyed by ID)
     * @param EncounterState $encounterState Current encounter state
     */
